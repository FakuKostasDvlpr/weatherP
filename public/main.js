// declaro los objetos que utilizare
...
const changeSearchMsg = async (cityData) =>{
    ...
    searchMsg.innerHTML = `Así está el clima en <span>${cityName}</span>, ¿Querés ver el clima de otra ciudad?`;
}
...
const searchCity = async (e) => {
    ...
    //input no este vacio
    if(isEmptyInput()){
        //tiramos error que funcionaria como un try catch
